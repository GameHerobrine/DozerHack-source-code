...
public class Block {
    ...
    public void setBlockBounds(double var1, double var2, double var3, double var4, double var5, double var6) {
    ...
    public float getBlockBrightness(IBlockAccess var1, int var2, int var3, int var4) {
    	if(GameSettings.fullbright || hacks.xray) {  
    		return 1.0f;
    	}
    	else {
    ...
    public boolean shouldSideBeRendered(IBlockAccess var1, int var2, int var3, int var4, int var5) {
    	if(hacks.xray) 
    	{
    		return blockID == 73 ||blockID == 10 ||blockID == 11 ||blockID == 56 || blockID == 14 || blockID == 15 || blockID == 16 || blockID == 19 || blockID == 46 || blockID == 57 || blockID == 41 || blockID == 42 || blockID == 54; 
    	}
