...
public class EntityRenderer {
    ...
    private static float debugCamFOV = 0.0F;
    private static float prevDebugCamFOV = 0.0F;
    ...
    public void getMouseOver(float var1) {
        ...
        float var3 = 70 + var5.fovSetting*50;
        if (var2.isInsideOfMaterial(Material.water)) {
            var3 = 60.0F + var5.fovSetting*50;
        }
        ...
        return var3 + EntityRenderer.prevDebugCamFOV + (EntityRenderer.debugCamFOV - EntityRenderer.prevDebugCamFOV) * var1;
    }
    ...
    public void updateCameraAndRender(float var1) throws InterruptedException, FileNotFoundException {
        if (!Display.isActive()) {
    ...
    public void renderWorld(float var1, long var2) {    	
        ...
        for(int var18 = 0; var18 < 2; ++var18) {
            ...
            EntityPlayer var21;
            if (this.mc.objectMouseOver != null && var4 instanceof EntityPlayer) {
