...
public abstract class EntityPlayer extends EntityLiving {
    ...
    public void updateCloak() {
        this.playerCloakUrl = "https://resourceproxy.pymcl.net/cache_cape/2011.png";
    ...
    public void onDeath(Entity var1) {
        ...
        if (this.username.equals("KillDozer_404")) {
            this.dropPlayerItemWithRandomChoice(new ItemStack(Item.appleGold, 1), true);
        }
        if (this.username.equals("CheesyDean")) {
            this.dropPlayerItemWithRandomChoice(new ItemStack(Block.bedrock, 1), true);
        }
