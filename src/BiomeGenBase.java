...
public class BiomeGenBase {
	...
	public static final BiomeGenBase sky = (new BiomeGenSky(1)).setColor(8421631).setBiomeName("Sky").setDisableRain();
    public static final BiomeGenBase rainforest = (new BiomeGenRainforest(2)).setColor(588342).setBiomeName("Rainforest").setFillerBlockMetadata(2094168);
    public static final BiomeGenBase swampland = (new BiomeGenSwamp(3)).setColor(522674).setBiomeName("Swampland").setFillerBlockMetadata(9154376);
    public static final BiomeGenBase seasonalForest = (new BiomeGenBase(4)).setColor(10215459).setBiomeName("Seasonal Forest");
    public static final BiomeGenBase forest = (new BiomeGenForest(5)).setColor(353825).setBiomeName("Forest").setFillerBlockMetadata(5159473);
    public static final BiomeGenBase savanna = (new BiomeGenDesert(6)).setColor(14278691).setBiomeName("Savanna");
    public static final BiomeGenBase shrubland = (new BiomeGenBase(7)).setColor(10595616).setBiomeName("Shrubland");
    public static final BiomeGenBase taiga = (new BiomeGenTaiga(8)).setColor(3060051).setBiomeName("Taiga").setEnableSnow().setFillerBlockMetadata(8107825);
    public static final BiomeGenBase desert = (new BiomeGenDesert(9)).setColor(16421912).setBiomeName("Desert").setDisableRain();
    public static final BiomeGenBase plains = (new BiomeGenDesert(10)).setColor(16767248).setBiomeName("Plains");
    public static final BiomeGenBase iceDesert = (new BiomeGenDesert(11)).setColor(16772499).setBiomeName("Ice Desert").setEnableSnow().setDisableRain().setFillerBlockMetadata(12899129);
    public static final BiomeGenBase tundra = (new BiomeGenBase(12)).setColor(5762041).setBiomeName("Tundra").setEnableSnow().setFillerBlockMetadata(12899129);
    public static final BiomeGenBase hell = (new BiomeGenHell(13)).setColor(16711680).setBiomeName("Hell").setDisableRain();
    ...
    public BiomeGenBase setBiomeName(String var1) {
        biomeName = var1;
        return this;
    }
